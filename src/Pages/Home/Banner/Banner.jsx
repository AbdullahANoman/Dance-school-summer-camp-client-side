      ...
      >
        <SwiperSlide>
          <div className="carousel-item relative w-full">
            ...
            <div className="absolute flex flex-row-reverse  gap-2  h-full w-full md:pl-96  items-center bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] rounded-xl ">
              <div className="text-white  w-1/2 md:pl-5  ">
                <p
                ...
                <p
                  className="uppercase text-4xl md:text-7xl mt-0 font-bold text-[#571F9C] "
                  data-aos="flip-left"
                ...
                <Bounce>
                  <div className="uppercase text-sm md:text-2xl">
                    <p>
                      {" "}
                ...
                <div className="flex gap-2 md:gap-10 uppercase mt-10">
                  <Link to="/classes">
                    <button
                      data-aos="fade-up"
                      data-aos-duration="1500"
                      className="px-2  md:px-6 py-2 md:py-4 text-sm md:text-lg font-semibold uppercase   bg-[#571F9C]"
                    >
                      our service
                    </button>
                  </Link>
                  <Link to="/instructors">
                    <button
                      ...
                      className="px-2  md:px-6 py-2 md:py-4 text-sm  md:text-lg font-semibold uppercase border   bg-transparent"
                    >
                      get a quote
                    </button>
                  </Link>
          ...
          <div className="carousel-item relative w-full">
            ...
            <div className="absolute flex  gap-2  h-full w-full pl-10 items-center bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)] rounded-xl">
              <div
                ...
                className="text-white space-y-10 w-full"
              >
                ...
                <div className="">
                  <div className="flex gap-2 justify-center md:gap-10 uppercase mt-10">
                    <Link to="/classes">
                      <button
                        data-aos="fade-up"
                        data-aos-duration="1500"
